...
interface GenreSelectorProps {
  ...
  onPick: (g: Genre) => void;
  /** When true, renders without the outer panel wrapper and heading (for embedding inside Transport) */
  embedded?: boolean;
}

export function GenreSelector({ activeId, onPick, embedded }: GenreSelectorProps) {
  const grid = (
